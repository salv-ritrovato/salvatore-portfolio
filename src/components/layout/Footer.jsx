...
export default function Footer() {
  const { t } = useLanguage()
  const { site, nav, socials, footer } = t
      ...
      <div className="container-x py-16">
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-3">
            <h3 className="mono-label mb-4 text-muted">{footer.navigate}</h3>
          ...
          <div className="md:col-span-4">
            <h3 className="mono-label mb-4 text-muted">{footer.connect}</h3>
        ...
        <div className="mt-14 flex flex-col items-start justify-between gap-4 border-t-2 border-line/15 pt-6 sm:flex-row sm:items-center">
          <p className="font-mono text-xs text-muted">{footer.copyright(year, site.name)}</p>
