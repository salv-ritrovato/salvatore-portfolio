...
const shared = {
  ...
  skillsItems: [
    { id: "html", name: "HTML5", glyph: "</>", category: "Markup", group: "frontend" },
    { id: "css", name: "CSS3", glyph: "#", category: "Style", group: "frontend" },
    { id: "js", name: "JavaScript", glyph: "JS", category: "Language", group: "frontend" },
    { id: "react", name: "React.js", glyph: "Re", category: "Framework", group: "frontend" },
    { id: "node", name: "Node.js", glyph: "N", category: "Runtime", group: "backend" },
    { id: "express", name: "Express.js", glyph: "Ex", category: "Backend", group: "backend" },
    { id: "mysql", name: "MySQL", glyph: "DB", category: "Database", group: "backend" },
    { id: "git", name: "Git", glyph: "⎇", category: "VCS", group: "tools" },
    { id: "github", name: "GitHub", glyph: "GH", category: "Platform", group: "tools" },
    { id: "npm", name: "npm", glyph: "np", category: "Tooling", group: "tools" },
    { id: "vscode", name: "VS Code", glyph: "{ }", category: "Editor", group: "tools" },
    { id: "cursor", name: "Cursor", glyph: "▸", category: "Editor", group: "tools" },
    { id: "claude-code", name: "Claude Code", glyph: "AI", category: "AI Tool", group: "ai" },
  ],
  learningItems: [
  ...
  it: {
    ...
    contact: {
      ...
      form: {
        ...
        successMessage: "Messaggio inviato! Ti rispondo al più presto.",
        errorMessage: "Errore nell'invio. Riprova o scrivimi direttamente.",
